...
function insertUser($user){
    ...
    $conn = getConnection();
    $sql = "insert into users values('', '{$user['user_id']}', '{$user['full_name']}', '{$user['email']}', '{$user['phone']}', '{$user['password']}', '{$user['address']}', '{$user['gender']}', '{$user['blood']}', '{$user['dob']}', '{$user['program']}', '','{$user['created_at']}','{$user['updated_at']}')";
